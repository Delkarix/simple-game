...
pub fn btowc(arg___c: c_int) callconv(.C) wint_t {
    var __c = arg___c;
    _ = &__c;
    return if (((__builtin_constant_p(__c) != 0) and (__c >= @as(c_int, '\x00'))) and (__c <= @as(c_int, '\x7f'))) @as(wint_t, @bitCast(__c)) else __btowc_alias(__c);
}
pub fn wctob(arg___wc: wint_t) callconv(.C) c_int {
    var __wc = arg___wc;
    _ = &__wc;
    return if (((__builtin_constant_p(__wc) != 0) and (__wc >= @as(wint_t, @bitCast(@as(c_int, '\u{0}'))))) and (__wc <= @as(wint_t, @bitCast(@as(c_int, '\u{7f}'))))) @as(c_int, @bitCast(__wc)) else __wctob_alias(__wc);
}
...
pub fn mbrlen(noalias arg___s: [*c]const u8, arg___n: usize, noalias arg___ps: [*c]mbstate_t) callconv(.C) usize {
    ...
    var __ps = arg___ps;
    _ = &__ps;
    return if (__ps != @as([*c]mbstate_t, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) mbrtowc(null, __s, __n, __ps) else __mbrlen(__s, __n, null);
}
...
// /usr/include/SDL3/SDL_stdinc.h:473:42: warning: ignoring StaticAssert declaration
...
pub extern fn SDL_unsetenv(name: [*c]const u8) c_int;
...
// /usr/include/SDL3/SDL_stdinc.h:3089:12: warning: TODO implement function '__builtin_add_overflow' in std.zig.c_builtins

// /usr/include/SDL3/SDL_stdinc.h:3085:22: warning: unable to translate function, demoted to extern
...
pub extern fn SDL_SignalSemaphore(sem: ?*SDL_Semaphore) c_int;
...
pub extern fn SDL_SetTLS(id: [*c]SDL_TLSID, value: ?*const anyopaque, destructor: SDL_TLSDestructorCallback) c_int;
...
pub extern fn SDL_AddSurfaceAlternateImage(surface: [*c]SDL_Surface, image: [*c]SDL_Surface) c_int;
...
pub extern fn SDL_PremultiplyAlpha(width: c_int, height: c_int, src_format: SDL_PixelFormat, src: ?*const anyopaque, src_pitch: c_int, dst_format: SDL_PixelFormat, dst: ?*anyopaque, dst_pitch: c_int, linear: SDL_bool) c_int;
pub extern fn SDL_PremultiplySurfaceAlpha(surface: [*c]SDL_Surface, linear: SDL_bool) c_int;
pub extern fn SDL_ClearSurface(surface: [*c]SDL_Surface, r: f32, g: f32, b: f32, a: f32) c_int;
...
pub extern fn SDL_BlitSurface(src: [*c]SDL_Surface, srcrect: [*c]const SDL_Rect, dst: [*c]SDL_Surface, dstrect: [*c]const SDL_Rect) c_int;
...
pub extern fn SDL_BlitSurfaceScaled(src: [*c]SDL_Surface, srcrect: [*c]const SDL_Rect, dst: [*c]SDL_Surface, dstrect: [*c]const SDL_Rect, scaleMode: SDL_ScaleMode) c_int;
...
pub extern fn SDL_BlitSurfaceTiled(src: [*c]SDL_Surface, srcrect: [*c]const SDL_Rect, dst: [*c]SDL_Surface, dstrect: [*c]const SDL_Rect) c_int;
pub extern fn SDL_BlitSurfaceTiledWithScale(src: [*c]SDL_Surface, srcrect: [*c]const SDL_Rect, scale: f32, scaleMode: SDL_ScaleMode, dst: [*c]SDL_Surface, dstrect: [*c]const SDL_Rect) c_int;
pub extern fn SDL_BlitSurface9Grid(src: [*c]SDL_Surface, srcrect: [*c]const SDL_Rect, left_width: c_int, right_width: c_int, top_height: c_int, bottom_height: c_int, scale: f32, scaleMode: SDL_ScaleMode, dst: [*c]SDL_Surface, dstrect: [*c]const SDL_Rect) c_int;
...
pub extern fn SDL_ReadSurfacePixelFloat(surface: [*c]SDL_Surface, x: c_int, y: c_int, r: [*c]f32, g: [*c]f32, b: [*c]f32, a: [*c]f32) c_int;
pub extern fn SDL_WriteSurfacePixel(surface: [*c]SDL_Surface, x: c_int, y: c_int, r: Uint8, g: Uint8, b: Uint8, a: Uint8) c_int;
pub extern fn SDL_WriteSurfacePixelFloat(surface: [*c]SDL_Surface, x: c_int, y: c_int, r: f32, g: f32, b: f32, a: f32) c_int;
...
pub extern fn SDL_GetClosestFullscreenDisplayMode(displayID: SDL_DisplayID, w: c_int, h: c_int, refresh_rate: f32, include_high_density_modes: SDL_bool, mode: [*c]SDL_DisplayMode) c_int;
...
pub extern fn SDL_GetWindowSafeArea(window: ?*SDL_Window, rect: [*c]SDL_Rect) c_int;
...
pub extern fn SDL_StartTextInputWithProperties(window: ?*SDL_Window, props: SDL_PropertiesID) c_int;
...
pub const SDL_EVENT_WINDOW_PEN_ENTER: c_int = 538;
pub const SDL_EVENT_WINDOW_PEN_LEAVE: c_int = 539;
pub const SDL_EVENT_WINDOW_HDR_STATE_CHANGED: c_int = 540;
pub const SDL_EVENT_WINDOW_FIRST: c_int = 514;
pub const SDL_EVENT_WINDOW_LAST: c_int = 540;
...
pub const SDL_FOLDER_TOTAL: c_int = 11;
...
pub extern fn SDL_CopyFile(oldpath: [*c]const u8, newpath: [*c]const u8) c_int;
...
pub extern fn SDL_SetAppMetadata(appname: [*c]const u8, appversion: [*c]const u8, appidentifier: [*c]const u8) c_int;
pub extern fn SDL_SetAppMetadataProperty(name: [*c]const u8, value: [*c]const u8) c_int;
...
pub extern fn SDL_CreateTexture(renderer: ?*SDL_Renderer, format: SDL_PixelFormat, access: SDL_TextureAccess, w: c_int, h: c_int) ?*SDL_Texture;
...
pub extern fn SDL_GetRenderSafeArea(renderer: ?*SDL_Renderer, rect: [*c]SDL_Rect) c_int;
...
pub extern fn SDL_RenderTextureTiled(renderer: ?*SDL_Renderer, texture: ?*SDL_Texture, srcrect: [*c]const SDL_FRect, scale: f32, dstrect: [*c]const SDL_FRect) c_int;
pub extern fn SDL_RenderTexture9Grid(renderer: ?*SDL_Renderer, texture: ?*SDL_Texture, srcrect: [*c]const SDL_FRect, left_width: f32, right_width: f32, top_height: f32, bottom_height: f32, scale: f32, dstrect: [*c]const SDL_FRect) c_int;
...
pub const struct_SDL_StorageInterface = extern struct {
    ...
    copy: ?*const fn (?*anyopaque, [*c]const u8, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*anyopaque, [*c]const u8, [*c]const u8) callconv(.C) c_int),
...
pub extern fn SDL_CopyStorageFile(storage: ?*SDL_Storage, oldpath: [*c]const u8, newpath: [*c]const u8) c_int;
...
pub extern fn SDL_SetLinuxThreadPriority(threadID: Sint64, priority: c_int) c_int;
pub extern fn SDL_SetLinuxThreadPriorityAndPolicy(threadID: Sint64, sdlPriority: c_int, schedPolicy: c_int) c_int;
...
// /usr/include/SDL3/SDL_stdinc.h:54:12
...
// /usr/include/SDL3/SDL_begin_code.h:199:9
...
// /usr/include/SDL3/SDL_assert.h:266:9
...
// /usr/include/SDL3/SDL_audio.h:111:9
...
// /usr/include/SDL3/SDL_oldnames.h:947:9
...
// /usr/include/SDL3/SDL_oldnames.h:948:9
...
// /usr/include/SDL3/SDL_oldnames.h:1063:9
...
// /usr/include/SDL3/SDL_oldnames.h:1064:9
...
// /usr/include/SDL3/SDL_oldnames.h:1098:9
...
// /usr/include/SDL3/SDL_oldnames.h:1130:9
...
// /usr/include/SDL3/SDL_oldnames.h:1131:9
...
// /usr/include/SDL3/SDL_oldnames.h:1147:9
...
// /usr/include/SDL3/SDL_oldnames.h:1148:9
...
// /usr/include/SDL3/SDL_oldnames.h:1187:9
...
// /usr/include/SDL3/SDL_oldnames.h:1214:9
...
// /usr/include/SDL3/SDL_oldnames.h:1215:9
...
// /usr/include/SDL3/SDL_oldnames.h:1226:9
...
// /usr/include/SDL3/SDL_oldnames.h:1227:9
...
// /usr/include/SDL3/SDL_oldnames.h:1237:9
...
// /usr/include/SDL3/SDL_oldnames.h:1238:9
...
pub const SDL_WinRTGetDeviceFamily = @compileError("unable to translate macro: undefined identifier `SDL_WinRTGetDeviceFamily_renamed_SDL_GetWinRTDeviceFamily`");
// /usr/include/SDL3/SDL_oldnames.h:1244:9
pub const SDL_GetWinRTFSPathUTF8 = @compileError("unable to translate macro: undefined identifier `SDL_GetWinRTFSPathUTF8_renamed_SDL_GetWinRTFSPath`");
...
// /usr/include/SDL3/SDL_oldnames.h:1246:9
...
// /usr/include/SDL3/SDL_oldnames.h:1247:9
...
// /usr/include/SDL3/SDL_oldnames.h:1267:9
...
// /usr/include/SDL3/SDL_oldnames.h:1268:9
